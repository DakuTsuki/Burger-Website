...
const BurgerCard = ({ title, image, price, reviews }: Props) => {
  return (
    <div className="bg-white p-6 rounded-lg m-3">
      ...
      <h1 className="mt-[1.3rem] text-[22px] font-semibold">{title}</h1>
      ...
      <p className="mt-[0.5rem] text-black text-opacity-70">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum,</p>
