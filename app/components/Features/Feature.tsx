  ...
  return (
    <div className="pt-[5rem] pb-[3rem]">
      ...
      <div className="w-[90%] md:w-[80%] mt-[3rem] md:mt-[5rem] mb-[3rem] mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem]">
        {/* 1st card */}
        <div data-aos="fade-left"  data-aos-mirror="true" data-aos-once="false" data-aos-anchor-placement="top-center">
          <div className="p-6 hover:bg-white rounded-lg transition-all duration-200">
            ...
            <p className="mt-[0.2rem] text-black text-opacity-60 text-center">
              ...
              dolorum inventore asperiores ipsum necessitatibus numquam nihil,
              distinctio accusamus eum. Aspernatur assumenda esse consequatur
              perferendis nisi molestias natus commodi debitis alias?
            </p>
          </div>
        </div>
        {/* 2nd Card */}
