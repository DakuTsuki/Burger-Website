...
const Hero = () => {
  return (
    ...
    >
      {/* First Hero section */}
      <div className=" md:clip_path w-[100%] h-[88vh] flex items-center justify-center flex-col bg-red-950">
        <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
          ...
          <div className="">
            ...
            <p className="mt-[1rem] text-white text-opacity-70 text-[18px]">
              ...
              veritatis consequuntur cumque corrupti mollitia iure veniam sunt,
              nesciunt nam soluta possimus, numquam ad, voluptatem sint.
            </p>
      ...
      {/* Second slide */}
      <div className=" md:clip_path w-[100%] h-[88vh] flex items-center justify-center flex-col bg-blue-950">
        <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
          {/* Image */}
